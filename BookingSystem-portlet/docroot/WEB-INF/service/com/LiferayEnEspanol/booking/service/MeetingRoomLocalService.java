...
/**
 * Provides the local service interface for MeetingRoom. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jesus Flores
 * @see MeetingRoomLocalServiceUtil
...
public interface MeetingRoomLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MeetingRoomLocalServiceUtil} to access the meeting room local service. Add custom service methods to {@link com.LiferayEnEspanol.booking.service.impl.MeetingRoomLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
