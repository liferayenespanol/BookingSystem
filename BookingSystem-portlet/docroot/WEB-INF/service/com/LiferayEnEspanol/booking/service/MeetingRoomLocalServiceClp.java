 ...
 * @generated
 */
public class MeetingRoomLocalServiceClp implements MeetingRoomLocalService {
    ...
    public MeetingRoomLocalServiceClp(
        ...
        _methodName21 = "findByCapacity";

        _methodParameterTypes21 = new String[] { "int", "boolean" };
    }
    ...
    public com.LiferayEnEspanol.booking.model.MeetingRoom addMeetingRoom(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(meetingRoom) });
        } catch (Throwable t) {
        ...
        return (com.LiferayEnEspanol.booking.model.MeetingRoom) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.LiferayEnEspanol.booking.model.MeetingRoom createMeetingRoom(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { meetingRoomId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.LiferayEnEspanol.booking.model.MeetingRoom deleteMeetingRoom(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { meetingRoomId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.LiferayEnEspanol.booking.model.MeetingRoom fetchMeetingRoom(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { meetingRoomId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.LiferayEnEspanol.booking.model.MeetingRoom getMeetingRoom(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { meetingRoomId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.LiferayEnEspanol.booking.model.MeetingRoom> getMeetingRooms(
        ...
        return (java.util.List<com.LiferayEnEspanol.booking.model.MeetingRoom>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.Collection findByCapacity(int capacity) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { capacity });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
        ...
        return (java.util.Collection) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.Collection findByCapacity(int capacity, boolean active) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    _methodParameterTypes21, new Object[] { capacity, active });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
